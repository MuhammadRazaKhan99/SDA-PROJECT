...
public class C_Player_Dietplan2 extends Controller 
{
	...
	@FXML	private ImageView selectplanicon;
	  ...
	  {
		  System.out.println("C_Player_Dietplan2 receive"+n);
		  Stage p=new Stage();
		  setupstage(p,"S_Dietplan2.fxml",n);	  
	  }
	  //custom plan icon
	    @FXML
		void click_customplanicon(MouseEvent event)
		{
			 ...
			 currentStage.close();
			 C_Player_Dietplan c=new C_Player_Dietplan();
			 c.createstage(_name);
		}
	    @FXML
		...
		void click_selectplanicon(MouseEvent event)
		{
			 Stage currentStage = (Stage) ((Node) event.getSource()).getScene().getWindow();		    
			 currentStage.close();
			 C_Player_Dietplan4 c=new C_Player_Dietplan4();
			 c.createstage(_name);
		}
	    @FXML
		...
		void click_yourplanicon(MouseEvent event)
		{
			 Stage currentStage = (Stage) ((Node) event.getSource()).getScene().getWindow();		    
			 currentStage.close();
			 C_Player_Dietplan3 c=new C_Player_Dietplan3();
			 c.createstage(_name);
		}
	    @FXML
